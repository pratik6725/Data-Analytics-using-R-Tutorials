...
#Lets create our own dataframe now
Students<- c("Rohan","Zack","Mona","Hannah","Rio","Taylor","Brendon","Smith","Jessica")
Weight <- c("58","62","53","56","58","72","81","73","72")
Gender <- c("M","M","F","F","M","F","M","M","F")

#Lets create dataframe using these values
...
#What is dimension of dataframe?
dim(df)
...
#Dataframe for just particular set of data
df[2:4,]
